  ...
  const projects = [
    {
      ...
      background: "python package for processing and analyzing time-of-flight mass spectrometry data",
      links: {
        "Github": "https://github.com/Meredith-Lab/py-tofspec",
        "Documentation": "https://meredith-lab.github.io/py-tofspec/"
      }
    }
  ];
  $$result.css.add(css);
